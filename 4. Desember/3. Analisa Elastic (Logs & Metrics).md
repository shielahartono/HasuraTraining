...
1. Pada Code JSON diatas memilki arti bahwa untuk status cache untuk service code diatas berstatus "miss" yang berarti bahwa permintaan cache tidak ditemukan, sehingga perlu dilakukan fallback untuk memproses permintaan tersebut.
